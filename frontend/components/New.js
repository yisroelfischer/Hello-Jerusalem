...
function New({parentCallback}) {
    ...
    return(
        ...
        <Chat context={`The user is on a page where they can select from a list of sites they want
        ...
        <form>
            ...
            <div className='form-main'>
                {(list.list) && <div id='list' className='list'>
                    {list.list.map((site) => 
            ...
            <div className='form-foot'>
                <button className='button'
                 onClick={handleSubmit}>Begin tour</button>
            </div>      
        </form>
        </div>
    )
